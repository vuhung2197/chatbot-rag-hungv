...
const translations = {
  vi: {
    ...
    'profile.avatarUpdateSuccess': 'Đã cập nhật avatar thành công!',

    // Wallet
    'wallet.myWallet': 'Ví của tôi',
    'payment.success': 'Thanh toán thành công!',
    'payment.addedToWallet': 'đã được thêm vào ví của bạn.',
    ...
    'subscription.billingCycle.monthly': 'Tháng',
    'subscription.billingCycle.yearly': 'Năm',
    ...
    'subscription.autoRenew': 'Tự động gia hạn',
    'subscription.autoRenewEnabled': 'Đã bật tự động gia hạn',
    'subscription.autoRenewDisabled': 'Đã tắt tự động gia hạn',
    'subscription.autoRenewEnable': 'Bật tự động gia hạn',
    'subscription.autoRenewDisable': 'Tắt tự động gia hạn',
  ...
  en: {
    ...
    'payment.addedToWallet': 'has been added to your wallet.',
    ...
    'subscription.autoRenewEnabled': 'Auto renewal enabled',
    'subscription.autoRenewDisabled': 'Auto renewal disabled',
    'subscription.autoRenewEnable': 'Enable auto renewal',
    'subscription.autoRenewDisable': 'Disable auto renewal',
