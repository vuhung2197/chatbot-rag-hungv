...
const WalletDashboard = ({ onCurrencyChange, refreshTrigger = 0 }) => {
    ...
    const handleCurrencyChange = (updatedWallet) => {
        ...
        if (onCurrencyChange) {
            onCurrencyChange(updatedWallet);
        }
    ...
    return (
        <div className="wallet-dashboard">
            ...
            {/* Transaction History */}
            <TransactionHistory currency={wallet?.currency} refreshTrigger={refreshTrigger} />
